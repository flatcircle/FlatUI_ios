...
extension RadioButton {
    ...
    func startSelectAnimation() {
        UIView.animate(withDuration: self.duration, delay: 0.0, usingSpringWithDamping: self.damping, initialSpringVelocity: self.velocity, options: UIView.AnimationOptions.allowUserInteraction, animations: { [unowned self] in
    ...
    func selectedAnimationFinish() {
        UIView.animate(withDuration: self.duration, delay: 0, usingSpringWithDamping: self.damping, initialSpringVelocity: self.velocity, options: UIView.AnimationOptions.allowUserInteraction, animations: { [unowned self] in
